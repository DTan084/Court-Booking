...
export default function CourtDetailPage({ params }: { params: { id: string } }) {
  ...
  const sportTypeLabel = court.sportTypeName?.trim() || null;
            ...
            <div className="mb-6 flex flex-wrap items-start justify-between gap-4 border-b border-slate-100 pb-5">
              <div>
                ...
                <div className="mt-3 flex items-center gap-2">
                  {sportTypeLabel && (
                    <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-slate-700">
                      {sportTypeLabel}
                    </span>
                  )}

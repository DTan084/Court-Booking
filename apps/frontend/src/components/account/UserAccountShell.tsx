...
const items = [
  { href: '/profile', label: 'Personal', icon: User },
  { href: '/bookings', label: 'My Bookings', icon: CalendarDays },
];

export function UserAccountShell({
  title,
  subtitle,
  children,
}: {
    ...
    <div className="min-h-[calc(100vh-64px)] bg-[#f8f9ff]">
      <div>
        <aside className="fixed left-0 top-16 z-20 hidden h-[calc(100vh-64px)] w-64 border-r border-slate-200 bg-slate-50 lg:block">
          <div className="p-6">
            <h2 className="text-xl font-black tracking-tighter text-slate-900">My Account</h2>
        ...
        <div className="w-full lg:pl-64">
          <header className="sticky top-16 z-10 border-b border-slate-200 bg-white/90 backdrop-blur">
